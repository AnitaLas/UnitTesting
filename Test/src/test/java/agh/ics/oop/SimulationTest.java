...
public class SimulationTest {
    ...
    void runTest() {
        ...
        List<Vector2d> finalPos_1 = List.of(
                ...
                new Vector2d(2, 1), // 3, 0
                new Vector2d(0, 1), // 0, 0
                new Vector2d(0, 0),
                new Vector2d(0, 1),
                new Vector2d(4, 1),
                new Vector2d(0, 4)
        ...
        // testy orientacji
        for (int i = 0; i < startingPos.size(); i++) {
            //System.out.println("orientacja ------------ " + i);
        ...
        // testy isAt
        for (int i = 0; i < startingPos.size(); i++) {
            //System.out.println("jest na POZYCJI " + i);
            assertEquals(sim_0.getAnimalList().get(i).isAt(startingPos.get(i)), sim_0.getAnimalList().get(i).isAt(finalPos_0.get(i)));
        }

        // testy toString
        for (int i = 0; i < startingPos.size(); i++) {
           //System.out.println("jest na toString " + i);
            assertEquals(sim_0.getAnimalList().get(i).getPosition().toString()
                            +" "+ sim_0.getAnimalList().get(i).getOrientation().toString(),
                    sim_0.getAnimalList().get(i).toString());
        }
